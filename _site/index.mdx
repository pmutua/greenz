...
{"description":"Building solutions with technology.","author":{"@type":"Person","name":"philip mutua"},"@type":"WebPage","url":"http://localhost:4000/index.mdx","publisher":{"@type":"Organization","logo":{"@type":"ImageObject","url":"http://localhost:4000/assets/icons/icon.png"},"name":"philip mutua"},"headline":"Blog","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
