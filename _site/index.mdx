...
{"@type":"WebPage","headline":"Blog","url":"http://localhost:4000/index.mdx","publisher":{"@type":"Organization","logo":{"@type":"ImageObject","url":"http://localhost:4000/assets/icons/icon.png"},"name":"philip mutua"},"author":{"@type":"Person","name":"philip mutua"},"description":"Building solutions with technology.","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
